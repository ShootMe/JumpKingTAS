namespace TASStudio {
	partial class Studio {
		...
		private void InitializeComponent() {
			...
			this.tasText = new TASStudio.Controls.RichText();
			...
			this.tasText.Language = TASStudio.Controls.Language.TAS;
			...
			this.tasText.TextChanged += new System.EventHandler<TASStudio.Controls.TextChangedEventArgs>(this.tasText_TextChanged);
			...
			this.tasText.LineInserted += new System.EventHandler<TASStudio.Controls.LineInsertedEventArgs>(this.tasText_LineInserted);
			this.tasText.LineNeeded += new System.EventHandler<TASStudio.Controls.LineNeededEventArgs>(this.tasText_LineNeeded);
			this.tasText.LineRemoved += new System.EventHandler<TASStudio.Controls.LineRemovedEventArgs>(this.tasText_LineRemoved);
			// 
			// Studio
			// 
